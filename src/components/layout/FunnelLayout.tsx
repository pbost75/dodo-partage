...
const FunnelLayout: React.FC<FunnelLayoutProps> = ({ 
  ...
  // Récupérer la fonction resetStore depuis le store
  ...
  return (
    <div className="min-h-screen bg-white relative">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:gap-6 gap-2 pt-6 pb-4">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm text-gray-500 font-['Lato']">Votre annonce de partage</span>
      ...
      {/* Footer de navigation sticky - IDENTIQUE à Dodomove */}
      <NavigationFooter />
      
      {/* Bouton de réinitialisation discret - IDENTIQUE à Dodomove */}
      <button
        onClick={handleReset}
